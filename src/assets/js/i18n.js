...
const I18N = {
  fr: {
    ...
    'search.songsEmpty': 'Recherchez un chant',
    'search.bibleEmpty': 'Recherchez un chapitre',
    ...
    'settings.projectionTitle': 'Projection',
    'settings.projectionScreen': 'Écran de projection',
    'settings.projectionScreenDesc': "Choisissez l'écran utilisé pour la projection.",
    ...
    'update.installRetry': "Réessayer l'installation",
    'update.updateTo': 'Mettre à jour vers la version {version}',
    'update.update': 'Mettre à jour Verso',
    ...
    'verse.bridge': 'Pont',
    'verse.intro': 'Introduction',
    'verse.outro': 'Final',
    'verse.prechorus': 'Pré-refrain',
    'verse.short.verse': 'S',
    'verse.short.chorus': 'R',
    'verse.short.bridge': 'Pont',
    'verse.short.intro': 'Intro',
    'verse.short.outro': 'Final',
    'verse.short.prechorus': 'Pré-R',
  ...
  en: {
    ...
    'search.songsEmpty': 'Search for a song',
    'search.bibleEmpty': 'Search for a chapter',
    ...
    'settings.projectionTitle': 'Projection',
    'settings.projectionScreen': 'Projection screen',
    'settings.projectionScreenDesc': 'Choose the screen used for projection.',
    ...
    'update.installRetry': 'Retry installation',
    'update.updateTo': 'Update to version {version}',
    'update.update': 'Update Verso',
    ...
    'verse.intro': 'Intro',
    'verse.outro': 'Outro',
    'verse.prechorus': 'Pre-chorus',
    'verse.short.verse': 'V',
    'verse.short.chorus': 'C',
    'verse.short.bridge': 'B',
    'verse.short.intro': 'Intro',
    'verse.short.outro': 'Outro',
    'verse.short.prechorus': 'PC',
    'list.live': 'On screen',
